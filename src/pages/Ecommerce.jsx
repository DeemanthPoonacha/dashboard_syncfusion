        ...
        bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$11266.96</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
          ...
          {earningData.map((item) => (
            ...
            >
              <button type='button'
                ...
                className='text-3xl opacity-0.9
        ...
        dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
          <div className='flex justify-between'>
            ...
            <div className='flex items-center gap-4'>
              ...
              text-grary-600 hover:drop-shadow-xl'>
                <span>
                  <GoPrimitiveDot/>
                </span>
                <span>Expense</span>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$77,636</span>
                  <span className='p-1.5 hover:drop-shadow-lg
                  cursor-pointer rounded-full
                  text-white bg-green-400 ml-3 text-xs'>43%</span>
                </p>
